...
class Usuario extends DBAbstractModel {
	...
	public function getAll() {
		$this->query = "SELECT id, nombre, apellidos, email, clave FROM usuarios";
		$this->get_results_from_query();
		$this->lista = $this->rows;	//rows es una propiedad protected, para extraer el array creamos una propiedad pública llamada lista y la retornamos
		return $this->lista;
	}
